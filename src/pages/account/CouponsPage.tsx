    ...
    <div className="space-y-6">
      ...
      {!isLoading && !isError && (
        <div className="flex flex-wrap gap-2">
          <Badge variant="success">{t("pawmart.coupons.active", { count: active.length })}</Badge>
          <Badge variant="default">{t("pawmart.coupons.usedExpired", { count: inactive.length })}</Badge>
        </div>
      )}

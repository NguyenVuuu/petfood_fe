          ...
          <div className="p-6 text-center">
            {paymentStatus === "success" ? (
              <div className="flex flex-col items-center justify-center space-y-4 py-4">
                ...
                <Button className="mt-4 w-full" onClick={() => navigate(`/my-account/orders/${completedOrderId}`)}>
              ...
              <div className="flex flex-col items-center justify-center space-y-4 py-4">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Thanh toán chưa hoàn tất. Bạn có thể thử lại từ trang chi tiết đơn hàng.
                </p>
                <Button
                  className="mt-4 w-full"
                  variant="outline"
                  onClick={() => navigate(`/my-account/orders/${completedOrderId}`)}
                >
                  Xem lại đơn hàng
                </Button>
              </div>
                ...
                <div className="mb-6 space-y-3 text-left">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                      Nhấn <span className="font-semibold text-red-500">Mở cổng thanh toán</span> (mở tab mới)
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-amber-100 text-xs font-bold text-amber-600 dark:bg-amber-900/30 dark:text-amber-400">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300">Hoàn tất thanh toán trên VNPay</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-amber-100 text-xs font-bold text-amber-600 dark:bg-amber-900/30 dark:text-amber-400">
                      3
                    </div>
                    <p className="text-sm text-gray-600 dark:text-gray-300">Quay lại trang này để xem kết quả</p>
                  </div>
                </div>

...
export function printOrderInvoice(order: Order, labels: InvoiceLabels, locale: string) {
...
export function downloadOrderInvoice(order: Order, labels: InvoiceLabels, locale: string) {
